...
conn = sqlite3.connect(r'C:\python\bot_intra\sqldb.db')
...
def create_sql():
    cur.execute("""CREATE TABLE IF NOT EXISTS telegram(
       userid_telegram INT PRIMARY KEY,
       login TEXT,
       password TEXT,
       cookie TEXT);
    """)
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS new_zayvki(
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS massiv_zayvok(
       userid_telegram INT,
       text TEXT,
